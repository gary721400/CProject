...
const U8 RadioPnCodeTable[ 20 ][ 8 ] =
{
...
void                RadioSetConstSopPnCode  ( U8  *patternAddr );
void                RadioSetConstDataPnCode ( U8  *patternAddr );
...
{
  RadioWrite( CRC_SEED_LSB_ADR, ( U8 )crcSeed );
  RadioWrite( CRC_SEED_MSB_ADR, ( U8 )( crcSeed >> 8 ));
...
//!
//! @return
void RadioSetConstDataPnCode( U8 __flash *patternAddr )
{
  U8 RadioCount = 16;
  do
...
{
  RadioSetConstSopPnCode(( U8 * )&RadioPnCodeTable[ patternNum ][ 0 ]);
}
