...
_GLOBEXT_   void                    protocol_init( void );
_GLOBEXT_   void                    protocol_button_bind( U8 dev_type );
_GLOBEXT_   void                    *protocol_get_tx_pkt( void );
_GLOBEXT_   PROTOCOL_STATUS         protocol_send_packet( U8 dev_type, U8 data_dev_type, U8 data_length );
_GLOBEXT_   U8                      radio_receive_packet( void );
