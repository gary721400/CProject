...
ImageDeclareType( PLAYER_AP3_TEMP_CODE01 );
...
Bool  cue_play_index_search   ( U8 index );
...
#pragma CODE = PLAYER_AP3_TEMP_CODE01
...
#pragma CODE = PLAYER_AP3_TEMP_CODE00

Bool cue_play( U8 index )
{
   SDKLoadCode( PLAYER_AP3_TEMP_CODE01 );
   if( !cue_play_index_search( index ))
      return FALSE;
#if 0
   if( player_ap3_is_busy())
   {
