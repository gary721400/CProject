...
//!
//! @version 1.3 snd3-dvk-1_9_5 $Id: scheduler.h,v 1.3 2005/04/01 07:30:14 coger Exp $
//!
//! @todo
//! @bug
//!
...
#include "poweroff_conf_scheduler.h"          // Configuration for the scheduler
...
#define SCHEDULER_FREE        3
  ...
  #error Scheduler_task_1_init must be defined in conf_scheduler.h file
#endif
  ...
  #error Scheduler_task_1 must be defined in conf_scheduler.h file
#endif
