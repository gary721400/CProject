...
ImageDeclareType( SET_CALIB_CODE );
ImageDeclareType( T01_COMMAND_02_CODE );
ImageDeclareType( T01_COMMAND_01_CODE );
...
//#pragma CODE = T01_COMMAND_CODE

#pragma CODE = T01_COMMAND_01_CODE
...
#pragma CODE = T01_COMMAND_02_CODE
...
{
 SDKLoadCode(T01_COMMAND_01_CODE);
 if(set_type){
	 ...
	 SDKLoadCode(T01_COMMAND_02_CODE);
...
//#pragma CODE = SET_CALIB_CODE
//#pragma CODE = T01_COMMAND_CODE
//#if( T01OID_CAB == ENABLE)
//#endif //


#pragma CODE = OID_INIT_CODE
