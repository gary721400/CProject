...
#define RADIO_SOP         MSK_SOFDET_IRQ  //0x40
#define RADIO_DATA        MSK_RXB1_IRQ   //0x08
#define RADIO_COMPLETE    MSK_RXC_IRQ   //0x02
#define RADIO_ERROR       MSK_RXE_IRQ   //0x01
...
_GLOBEXT_ XACT_CONFIG RadioXactConfig;
_GLOBEXT_ RADIO_STATE RadioState;
_GLOBEXT_ U8          RadioRetryCount;
_GLOBEXT_ U8          RadioPacketLength;
