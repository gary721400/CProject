...
ImageDeclareType( CHANGE_PROJ_CODE );
   ...
   switch( event )
   {
      ...
      case EVT_UPDATE_START:
         ...
         {  // The default application selected after power on
            ( void )mmgr_activate_mmi_appli(MMI_APPLI_RECORDER, 0);
...
{
   //strcpy( tisiFileName, SUBDIR_PATH );
