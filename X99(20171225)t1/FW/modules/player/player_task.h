...
#if 0
//#define sbufL_ADPCM              ( UCHAR volatile xdata *)0xB800
//#define ADPCMBufL                ( UCHAR volatile xdata *)0xB800
...
//_GLOBEXT_ _MEM_TYPE_SLOW_ _FileData FileData;
