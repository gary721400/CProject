...
//!
//! @brief This file defines the communication between navigation & file module and fat module
//!
//! @version 1.26 snd3-dvk-1_9_5 $Id: fs_com.h,v 1.26 2007/08/30 09:24:35 sguyon Exp $
//!
//! @todo
//! @bug
...
//! @{
typedef U16 UNICODE;
typedef U8        * FS_STRING;
typedef UNICODE   * FS_STR_UNICODE;
//! @}
...
//! \defgroup FS_Errors File System errors list
//! @{
...
_GLOBEXT_ _MEM_TYPE_MEDSLOW_ Fs_status fs_g_status;

#define  FAT_CLUSTER_BUF         ENABLE
//#define  FAT_CLUSTER_BUF         DISABLE
