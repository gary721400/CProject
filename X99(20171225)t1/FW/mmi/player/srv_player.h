...
//#define  SRVPLAYER_VOL_LEVEL        8//5//
...
_GLOBEXT_   _MEM_TYPE_MEDSLOW_   Srv_player_states    srvplayer_g_player_state;
_GLOBEXT_   _MEM_TYPE_MEDSLOW_   St_player_arg        srvplayer_g_arg;
_GLOBEXT_   _MEM_TYPE_MEDSLOW_   Elapsed_time         srvplayer_all_time;

//_GLOBEXT_   _MEM_TYPE_SLOW_   Elapsed_time   srvplayer_g_current_time;
