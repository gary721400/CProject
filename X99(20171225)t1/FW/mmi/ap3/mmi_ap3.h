...
ImageDeclareType( MMI_AP4_TEMP_CODE09 );
...
//ImageDeclareType( ADB_INIT_CODE );
ImageDeclareType( MMI_AP4_BAKKEY_PRESS_CODE );
ImageDeclareType( OID_NEXT_PRESS_CODE );
ImageDeclareType( MMI_AP4_NO_PLAYER_CODE );

ImageDeclareType(HINT_NAME_COPY_CODE);
