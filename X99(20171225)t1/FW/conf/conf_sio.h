...
//! Values: - ENABLED  :enable paster
//!         - DISABLED : disable paster
//#define RECORDER                      ( DISABLE )
#define RECORDER                      ( ENABLE )
...
//! --- ap4 RP ---
//! Values: - ENABLED  :enable ap4 RP
//!         - DISABLED : disable ap4 RP
//#define AP4_RP                      ( DISABLE )
#define AP4_RP                      ( ENABLE )
...
//! --- I speak ---
//! Values: - ENABLED  :enable I speak
//!         - DISABLED : disable I speak
#define i_speak                     ( DISABLE )
//#define i_speak                     ( ENABLE )
...
///*
//! --- select wireless or bluetooth ---
//! Values: - ENABLED  :enable select language menu
//!         - DISABLED : disable select language menu
//#define WIRELESS             			( DISABLE )
#define WIRELESS             			( ENABLE )

#define BLUETOOTH             			( DISABLE )
//#define BLUETOOTH             				( ENABLE )


//#define			MP3_AB             				( DISABLE )
#define 			MP3_AB             				( ENABLE )


//#define			ADB_FIND             				( DISABLE )
#define 			ADB_FIND             				( ENABLE )

//#define				DIY_REC             				( DISABLE )
#define 			DIY_REC             				( ENABLE )


//#define				REREAD_MODE             				( DISABLE )
#define 			REREAD_MODE             				( ENABLE )


//*/
#define BAT_NiMH                    1
#define BAT_LiIon                   2
//#define BAT_TYPE                    BAT_NiMH
#define BAT_TYPE                    BAT_LiIon
...
#define BLUETOOTH_CLOSE				0
#define BLUETOOTH_OPEN				1
//#define BLUETOOTH_FLAG             ( DISABLE )
#define BLUETOOTH_FLAG             ( ENABLE )
#if( BLUETOOTH_FLAG == ENABLE)
#define BLUETOOTH_STATUS			BLUETOOTH_CLOSE
#endif



//#define ALARM_FLAG             ( DISABLE )
#define ALARM_FLAG             ( ENABLE )
#if( BLUETOOTH_FLAG == ENABLE)
#define ALARM_NUM				10 //default alarm 10 mins
#endif
...
#define EARPHONE_SPEAKER_VOL        4
#define MP3_SPEAKER_VOL             12
#define WAV_SPEAKER_VOL             15
